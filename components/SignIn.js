  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 mt-4">
        <button className="flex items-center justify-center gap-2 w-full px-4 py-4 bg-white text-black border border-1 border-light-300 rounded-full">
          <svg
            viewBox="0 0 24 24"
            width="24"
            height="24"
      ...
      <form className="mt-4 grid gap-2">
        ...
        <button className="px-2 py-4 rounded-full w-full flex gap-2 justify-center bg-black text-white">
          Sign In
        </button>
      </form>
